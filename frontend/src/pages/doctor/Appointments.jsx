...
const Appointments = () => {
    const { data: upcomingApt, loading: uloading, error: uerror } = useFetch("https://hacknocturne-medipal.onrender.com/upcomming-doc-appointments");
    const { data: pastApt, loading: ploading, error: perror } = useFetch("https://hacknocturne-medipal.onrender.com/past-doc-appointments");
