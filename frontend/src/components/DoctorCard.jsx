...
const DoctorCard = ({ doctor }) => {
    ...
    useEffect(() => {
        const response = async () => {
            const res = await axios.post("https://hacknocturne-medipal.onrender.com/maps", { address: doctor.clinicname + " " + doctor.clinicloc });
    ...
    const handleAppointment = async () => {
        ...
        try {
            ...
            const bookResponse = await axios.post(
                "https://hacknocturne-medipal.onrender.com/book-appointment",
                {
                    userId: UserID,
                    doctorId: DoctorID,
                    appointmentDate,
